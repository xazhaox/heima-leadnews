package com.aliyuncs.green.extension.itheima;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        IClientProfile profile = DefaultProfile
                .getProfile("cn-shanghai", "LTAI4GBCfsPHyM3nrV4c3zd7", "xk5a15g3uUSAprqXJ1FWlYPylet3kL");
        DefaultProfile
        ...
        try{
            ...
            imageBytes = FileUtils.readFileToByteArray(new File("E:\\LWallpaper\\fd4b5472405700759df25fdbbd2b000c.jpg"));
            // 上传到服务端。
